...
public class OrderServiceImpl implements OrderService {
    ...
    public Order save(Order order) {
        ...
        carOwnerService.addOrderToOwner(order.getId(), order.getCar().getCarOwner().getId());
        return orderFromDb;
    }
    ...
    public Order addServices(Long id, List<Long> serviceIds) {
        ...
        List<Service> services = serviceService.findAllById(serviceIds);
    ...
    private BigDecimal calculateTotalPrice(Order order) {
        int amountOfCarOwnerOrders =
                carOwnerService.getAmountOfCarOwnerOrders(order.getId());
        double productDiscountPercentage = PRODUCT_DISCOUNT * amountOfCarOwnerOrders;
        double serviceDiscountPercentage = SERVICE_DISCOUNT * amountOfCarOwnerOrders;
    ...
    private Service createNewDiagnosis() {
        ...
        return serviceService.save(diagnosis);
    }
}
